...
---@class AMToggleButtonOptions : {text: string, onClick: function, size?: table<number>, color?: table<number>}

---@class AMToggleButton
local button = AM:GetModule('toggle-button')
...
---@param self AMToggleButton
---@param options AMToggleButtonOptions
---@param parent Frame
---@return Frame
